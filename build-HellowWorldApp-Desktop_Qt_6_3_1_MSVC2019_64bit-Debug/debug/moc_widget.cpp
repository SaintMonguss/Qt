...
#include <memory>
#include "../../HellowWorldApp/widget.h"
...
QT_MOC_LITERAL(7, 13), // "widgetClicked"
QT_MOC_LITERAL(21, 0) // ""

    },
    "Widget\0widgetClicked\0"
};
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Widget::widgetClicked)) {
                *result = 0;
                return;
            }
        }
