...
Widget::Widget(QWidget *parent) : QWidget(parent) {
    ...
    //로그 저장
    QPushButton* logSaveButton = new QPushButton("Save", this);
    connect(logSaveButton, SIGNAL(clicked( )), qApp, SLOT(commandedSaveLog()));

    QHBoxLayout *buttonLayout = new QHBoxLayout;
    buttonLayout->addWidget(logSaveButton);
    ...
    connect(logSaveButton, SIGNAL(clicked()), this, SLOT(commandedSaveLog()));
}
...
void Widget::commandedSaveLog()
{
    logThread->saveData(message);
